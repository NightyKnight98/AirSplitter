...
%% Edge Compute & OpenIPC Downlink Network (Looping in the Pi)
...
%% The Video Modification Loop
OpenIPC_Cam[RunCam Bundled Sony Camera] -->|Native MIPI Ribbon Bus| Pi_Zero
Pi_Zero -->|Runs OpenCV/YOLO / Draws Bounding Boxes| Pi_Zero
Pi_Zero <-->|USB High-Speed Transcoded Stream with Overlays| OpenIPC_VTX
